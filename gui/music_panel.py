...
from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QGroupBox,
                              QPushButton, QLabel, QGridLayout, QSlider,
...
class MusicPanel(QWidget):
    ...
    def init_ui(self):
        ...
        self.base_pitch_spin.setValue(40)
        ...
        self.pitch_range_spin.setValue(40)
        ...
        results_layout.addWidget(QLabel('MIDI文件:'), 1, 2)
    ...
    def update_results(self, results):
        ...
        self.avg_pitch_label.setText(f"{results.get('avg_pitch', 0):.1f}")
        self.avg_tempo_label.setText(f"{results.get('avg_tempo', 0):.0f} BPM")
        self.note_count_label.setText(str(results.get('note_count', 0)))
        
        scale = results.get('scale', 'Major')
        instrument = results.get('instrument', 'Soft Piano')
        
        midi_path = results.get('midi_path', '')
        if midi_path:
            self.midi_path_label.setText(os.path.basename(midi_path))
        
        self.duration_label.setText(self.format_duration(self.music_duration))
        self.total_label.setText(self.format_duration(self.music_duration))
        self.position_label.setText('0:00')
        self.progress_slider.setValue(0)
